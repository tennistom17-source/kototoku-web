...
(function(){
  var socialIcons = {
    ...
    tiktok: '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M14 2v12.5a4.5 4.5 0 1 1-4.5-4.5"></path><path d="M14 2c.4 3 2.4 4.8 5.5 5v3c-2.2 0-4.1-.7-5.5-2"></path></svg>',
